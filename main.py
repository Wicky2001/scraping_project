...
import datetime
import os
from utills.clustering import cluster_articles

def run_clustering_only():
    results_json_file_location = r"results\summarized_articles\final_news_data_20250313_2331.json"
    output_folder_path = r"results\clusterd_articles"

    output_file_path = cluster_articles(results_json_file_location, output_folder_path)
    print(f"Clustered articles saved to: {output_file_path}")
